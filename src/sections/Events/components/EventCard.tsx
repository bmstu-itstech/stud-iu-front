  ...
  return (
    <div className="rounded-3xl bg-white overflow-hidden max-w-220 relative">
      ...
      <div
        ...
        style={{ backgroundImage: `linear-gradient(135deg, ${props.fillColor}, rgba(0 0 0 / 0.4), rgba(0 0 0 / 0))` }}
      />
      <Title level={4} className="absolute top-6 left-6 text-white z-20">{props.title}</Title>
      <div
        className="rounded-3xl text-center px-8 py-4 absolute bottom-46 left-6 z-20"
        style={{ backgroundColor: props.fillColor }}
      >
        <Caption level={2} className="text-white">Как это было</Caption>
      </div>
